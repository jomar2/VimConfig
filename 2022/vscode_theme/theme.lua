...
theme.load_syntax = function()
    ...
    local syntax = {
        ...
        Function = { c.vscFront, nil, 'none', nil },
        ...
        TSConstant = { c.vscFront, nil, 'none', nil },
        ...
        TSAttribute = { c.vscBlue, nil, 'none', nil },
        TSNamespace = { c.vscFront, nil, 'none', nil },
        TSFuncBuiltin = { c.vscFront, nil, 'none', nil },
        TSFunction = { c.vscFront, nil, 'none', nil },
        TSFuncMacro = { c.vscFront, nil, 'none', nil },
        TSParameter = { c.vscLightBlue, nil, 'none', nil },
        TSParameterReference = { c.vscLightBlue, nil, 'none', nil },
        TSMethod = { c.vscFront, nil, 'none', nil },
        TSField = { c.vscLightBlue, nil, 'none', nil },
        TSProperty = { c.vscLightBlue, nil, 'none', nil },
        TSConstructor = { c.vscBlue, nil, 'none', nil },
